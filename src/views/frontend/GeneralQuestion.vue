<template>
    <div>
        <b-card  title="প্রশ্ন তালিকা"
        >
        <b-row>
            
             <div class="d-flex flex-row-reverse">
                    <b-button variant="primary" class="ml-2" v-b-modal.new-data-form> নতুন প্রশ্ন যোগ করুন</b-button>
			 </div>
        </b-row>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <tr v-for="dataInfo,dataIndex in dataList.data">
                                ...
                                <td style="white-space: normal;">{{dataInfo.answer}}</td>
        ...
        <b-modal id="data-edit-form" title="প্রশ্ন তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   
                   <b-row>
                    <b-col>
                        <b-input-group prepend="প্রশ্ন" class="mt-3">
                   ...
                   <b-row>
                    <b-col>
                        <b-input-group prepend="উত্তর" class="mt-3">
                           <textarea class="form-control" rows="6" placeholder="উত্তর" v-model="answer"></textarea>
                        </b-input-group>
          ...
          <b-modal id="new-data-form" title="প্রশ্ন তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
    ...
    methods:{
      dataStatusChange(dataId,status) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/general-question/info/status/change?dataId="+dataId+"&status="+status;
         ...
         deleteDataInfo(dataId) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/general-question/info/delete?dataId="+dataId;
        ...
        async updateDataInfo(){
            ...
            let url="staff/frontend/general-question/info/update";
        ...
        async storeDataInfo(){
            ...
            let url="staff/frontend/general-question/info/store";
        ...
        async getDataInfo(dataId){
            ...
            let url="staff/frontend/general-question/info?dataId="+dataId;
            this.dataId=dataId;
            await this.$http.get(url,config)
             .then(response=>{
                if(response.data.msgFlag==true){
                    ...
                    this.answer=response.data.dataInfo.answer;
        ...
        loadPhoto(e){
         ...
         getDataList(){
            ...
            let url="staff/frontend/general-question/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&searchKey="+this.searchKey;
