<template>
    <div>
        <b-card  title="গ্যাজেট তালিকা"
        >
        <b-row>
            
             <div class="d-flex flex-row-reverse">
                    <b-button variant="primary" class="ml-2" v-b-modal.new-data-form> নতুন গ্যাজেট যোগ করুন</b-button>
			 </div>
        </b-row>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <tr v-for="dataInfo,dataIndex in dataList.data">
                                ...
                                <td>
                                    <a :href="dataInfo.gadgetLink" target="_blank">{{dataInfo.gadgetLink }}</a>
                                </td>
                                <!-- <td>
        ...
        <b-modal id="data-edit-form" title="গ্যাজেট তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <!-- <b-row>
                    <b-col>
                   ...
                   <b-row>
                    <b-col>
                      ...
                      <b-form-group  prepend="পিডিএফ" label-cols-sm="2">
                            <b-form-file id="file-default" ref="gadget" accept="pdf/*"  @change="loadPdf"></b-form-file>
                          </b-form-group>
                    </b-col>
                   </b-row>
                   <b-row>
          ...
          <b-modal id="new-data-form" title="গ্যাজেট তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <!-- <b-row>
                    <b-col>
    ...
    methods:{
      dataStatusChange(dataId,status) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/dgadget/info/status/change?dataId="+dataId+"&status="+status;
         ...
         deleteDataInfo(dataId) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/dgadget/info/delete?dataId="+dataId;
        ...
        async updateDataInfo(){
            ...
            let url="staff/frontend/gadget/info/update";
            ...
            let formData=new FormData();
                ...
                if(this.$refs.gadget.files[0]!=null)
                     formData.append("gadget",this.$refs.gadget.files[0]);
        ...
        async storeDataInfo(){
            ...
            let url="staff/frontend/gadget/info/store";
        ...
        async getDataInfo(dataId){
            ...
            let url="staff/frontend/gadget/info?dataId="+dataId;
            this.dataId=dataId;
        ...
        loadPdf(e){
         ...
         getDataList(){
            ...
            let url="staff/frontend/gadget/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&searchKey="+this.searchKey;
