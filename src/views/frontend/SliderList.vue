<template>
    <div>
        <b-card  title="স্লাইডার তালিকা"
        >
        <b-row>
            
             <div class="d-flex flex-row-reverse">
                    <b-button variant="primary" class="ml-2" v-b-modal.new-data-form> নতুন স্লাইডার যোগ করুন</b-button>
			 </div>
        </b-row>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <tr v-for="dataInfo,dataIndex in dataList.data">
                                ...
                                <td>
                                    <img v-lazy="dataInfo.sliderUrl" :alt="dataInfo.name" height="70" width="70">
                                </td>
                                <td>{{dataInfo.sliderName}}</td>
        ...
        <b-modal id="data-edit-form" title="স্লাইডার তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <b-row>
                    <b-col>
          ...
          <b-modal id="new-data-form" title="স্লাইডার তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <b-row>
                    <b-col>
    ...
    methods:{
      dataStatusChange(dataId,status) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/slider/info/status/change?dataId="+dataId+"&status="+status;
         ...
         deleteDataInfo(dataId) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/slider/info/delete?dataId="+dataId;
        ...
        async updateDataInfo(){
            ...
            let url="staff/frontend/slider/info/update";
        ...
        async storeDataInfo(){
            ...
            let url="staff/frontend/slider/info/store";
        ...
        async getDataInfo(dataId){
            ...
            let url="staff/frontend/slider/info?dataId="+dataId;
            this.dataId=dataId;
            await this.$http.get(url,config)
             .then(response=>{
                if(response.data.msgFlag==true){
                    
                    this.name=response.data.dataInfo.sliderName;
        ...
        loadPhoto(e){
         ...
         getDataList(){
            ...
            let url="staff/frontend/slider/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&searchKey="+this.searchKey;
