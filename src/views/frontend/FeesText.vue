<template>
    <div>
        <b-card  title="ফি টেক্সট তালিকা"
        >
        <b-row>
            
             <div class="d-flex flex-row-reverse">
                    <b-button variant="primary" class="ml-2" v-b-modal.new-data-form> নতুন ফি টেক্সট যোগ করুন</b-button>
             </div>
        </b-row>
        ...
        <b-modal id="data-edit-form" title="ফি টেক্সট তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
          ...
          <b-modal id="new-data-form" title="ফি টেক্সট তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
...
export default{
    ...
    dataStatusChange(dataId,status) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/fees-text/info/status/change?dataId="+dataId+"&status="+status;
         ...
         deleteDataInfo(dataId) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/fees-text/info/delete?dataId="+dataId;
      ...
      handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
        ...
        async updateDataInfo(){
            ...
            let url="staff/frontend/fees-text/info/update";
        ...
        async storeDataInfo(){
            ...
            let url="staff/frontend/fees-text/info/store";
        ...
        async getDataInfo(dataId){
            ...
            let url="staff/frontend/fees-text/info?dataId="+dataId;
            this.dataId=dataId;
        ...
        loadPhoto(e){
         ...
         getDataList(){
            ...
            let url="staff/frontend/fees-text/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&searchKey="+this.searchKey;
