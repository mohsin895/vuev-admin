<template>
    <div>
        <b-card  title="আইন ফর্ম তালিকা"
        >
        <b-row>
            
             <div class="d-flex flex-row-reverse">
                    <b-button variant="primary" class="ml-2" v-b-modal.new-data-form> নতুন আইন ফর্ম যোগ করুন</b-button>
			 </div>
        </b-row>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <tr v-for="dataInfo,dataIndex in dataList.data">
                                ...
                                <td>
                                    <a :href="dataInfo.formLink" target="_blank">{{dataInfo.formLink }}</a>
                                </td>
                                <!-- <td>
        ...
        <b-modal id="data-edit-form" title="আইন ফর্ম তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <!-- <b-row>
                    <b-col>
                   ...
                   <b-row>
                    <b-col>
                      ...
                      <b-form-group  prepend="পিডিএফ" label-cols-sm="2">
                            <b-form-file id="file-default" ref="lawForm" accept="pdf/*"  @change="loadPdf"></b-form-file>
                          </b-form-group>
                    </b-col>
                   </b-row>
                   <b-row>
          ...
          <b-modal id="new-data-form" title="আইন ফর্ম তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <!-- <b-row>
                    <b-col>
    ...
    methods:{
      dataStatusChange(dataId,status) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/law-form/info/status/change?dataId="+dataId+"&status="+status;
         ...
         deleteDataInfo(dataId) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/law-form/info/delete?dataId="+dataId;
        ...
        async updateDataInfo(){
            ...
            let url="staff/frontend/law-form/info/update";
            ...
            let formData=new FormData();
                ...
                if(this.$refs.lawForm.files[0]!=null)
                     formData.append("lawForm",this.$refs.lawForm.files[0]);
        ...
        async storeDataInfo(){
            ...
            let url="staff/frontend/law-form/info/store";
        ...
        async getDataInfo(dataId){
            ...
            let url="staff/frontend/law-form/info?dataId="+dataId;
            this.dataId=dataId;
        ...
        loadPdf(e){
         ...
         getDataList(){
            ...
            let url="staff/frontend/law-form/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&searchKey="+this.searchKey;
