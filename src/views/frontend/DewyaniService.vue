<template>
    <div>
        <b-card  title="দেওয়ানি সেবা তালিকা"
        >
        <b-row>
            
             <div class="d-flex flex-row-reverse">
                    <b-button variant="primary" class="ml-2" v-b-modal.new-data-form> নতুন দেওয়ানি সেবা যোগ করুন</b-button>
			 </div>
        </b-row>
        ...
        <b-modal id="data-edit-form" title="দেওয়ানি সেবা তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <b-row>
                    <b-col>
          ...
          <b-modal id="new-data-form" title="দেওয়ানি সেবা তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <b-row>
                    <b-col>
...
export default{
    ...
    dataStatusChange(dataId,status) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/dewyani-service/info/status/change?dataId="+dataId+"&status="+status;
         ...
         deleteDataInfo(dataId) {
          ...
          let token=window.localStorage.getItem("token");
            ...
            let url="staff/frontend/dewyani-service/info/delete?dataId="+dataId;
      ...
      handleImageAdded: function(file, Editor, cursorLocation, resetUploader) {
        ...
        async updateDataInfo(){
            ...
            let url="staff/frontend/dewyani-service/info/update";
        ...
        async storeDataInfo(){
            ...
            let url="staff/frontend/dewyani-service/info/store";
         ...
         getDataInfo(dataId){
            ...
            let url="staff/frontend/dewyani-service/info?dataId="+dataId;
            this.dataId=dataId;
             this.$http.get(url,config)
             .then(response=>{
                if(response.data.msgFlag==true){
        ...
        loadPhoto(e){
         ...
         getDataList(){
            ...
            let url="staff/frontend/dewyani-service/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&searchKey="+this.searchKey;
