<template>
    <div>
        <b-card  title="নিবন্ধিত মামলা তালিকা"
        >
            ...
            <div class="table-info" >
                ...
                >
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <tr v-for="dataInfo,dataIndex in dataList.data" :key="dataIndex" :class="(dataInfo.status==3) ? 'text-danger':''">
                                ...
                                <td>
                                 <slot v-if="$store.state.userInfo.permissions.includes(15)">   
                                    <a href="#" class="text-primary" v-b-modal.application-form-view @click="getApplicationDetails(dataInfo.id);dataId=dataInfo.id">
           ...
           <b-modal id="application-form-view" title="আবেদনের  বিবরণ" size="xl" ok-only ok-variant="secondary" ok-title="Close">
            ...
            <b-row>
                ...
                <b-col>
                    <table>
                        <tr>
                            <th>মামলার ধরণ :</th>
                            <td>
                                <span class="form-control">{{applicationDetails.caseType}}</span>
                            </td>
                            <th>মামলার ফি :</th>
                            <td>
                                <span class="form-control">{{applicationDetails.caseFee | banglaNumber}} </span>টাকা 
                            </td>
                        </tr>
                ...
                <b-col>
                    <slot v-if="applicationDetails.applicant_infos!=null">
                        <img :src="applicationDetails.applicant_infos[0].photo " style="height:100px;width:100px; border-radius:20px;">
                    </slot>
                </b-col>
            </b-row>
            <b-row>
            ...
            <b-row class="mt-4">
                <b-col class="text-center">
                    ...
                    <h6 class="mt-4">আবেদনকারীর পক্ষে :</h6>
                </b-col>
            </b-row>
            <b-row class="mt-4">
                <b-col>
                ...
                <b-col>
                    <table class="table table-borderless caption-top">
                        ...
                        <tr>
                            <th>নাম :</th>
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[0].name}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[0].guardian}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[0].village}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[0].wordNo | banglaNumber}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[0].postOffice}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    <slot v-if="applicationDetails.oppositor_nominators[0].union_info!=null">
                                        {{applicationDetails.oppositor_nominators[0].union_info.bn_name}}
                                    </slot>
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    <slot v-if="applicationDetails.oppositor_nominators[0].district_info!=null">
                                        {{applicationDetails.oppositor_nominators[0].district_info.bn_name}}
                                    </slot>
                                </slot>
                            </td>
                        </tr>
                ...
                <b-col>
                    <table class="table table-borderless caption-top">
                        ...
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[1].name}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[1].guardian}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[1].village}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[1].wordNo | banglaNumber}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    {{applicationDetails.oppositor_nominators[1].postOffice}}
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    <slot v-if="applicationDetails.oppositor_nominators[1].union_info!=null">
                                        {{applicationDetails.oppositor_nominators[1].union_info.bn_name}}
                                    </slot>
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <slot v-if="applicationDetails.oppositor_nominators!=null">
                                    <slot v-if="applicationDetails.oppositor_nominators[1].district_info!=null">
                                        {{applicationDetails.oppositor_nominators[1].district_info.bn_name}}
                                    </slot>
                                </slot>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <th>
                                <slot v-if="$store.state.userInfo.permissions.includes(15)">
                                    <a href="#" class="btn btn-sm text-primary float-right" @click="generateReport()">
                                        <icon name="print" />
                                    </a>
                                </slot>
                            </th>
  ...
  methods:{
    ...
    resetForm(){
        ...
        async generateReport () {
            ...
            let url="staff/get/applcation/details?dataId="+this.dataId;
        ...
        async getDataList(){
            ...
            let url="staff/get/case/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&isOngoing="+this.isOngoing+"&isTransfer="+this.isTransfer+"&isOrdered="+this.isOrdered+"&isDegreed="+this.isDegreed+"&status="+this.status+"&searchKey="+this.searchKey+"&unionId="+this.union+
