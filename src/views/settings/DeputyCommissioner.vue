<template>
    <div>
        <b-card  title="জেলা প্রশাসক তালিকা"
        >
        <b-row>
            <b-col></b-col>
            <b-col class="float-right">
                <slot v-if="$store.state.userInfo.permissions.includes(54)">
                    <b-button variant="primary" class="ml-2" v-b-modal.new-dc-form> নতুন জেলা প্রশাসক যোগ করুন</b-button>
                </slot>
            </b-col>
        </b-row>
                    ...
                    <table class="table table-bordered table-hover" >
                        ...
                        <tbody>
                            <tr v-for="dataInfo,dataIndex in dataList.data">
                                ...
                                <slot v-if="$store.state.userInfo.permissions.includes(55)">
                                    <a href="#" class="text-primary" v-b-modal.member-edit-form @click="getDcInfo(dataInfo.id)">
                                        <icon name="eye" size="15px"/>
                                    </a>
                                </slot>
                                <slot v-if="$store.state.userInfo.permissions.includes(56)">
        ...
        <b-modal id="dc-edit-form" title="জেলা প্রশাসক তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <b-row>
                    <b-col>
                   ...
                   <b-row class="mt-2">
                       ...
                       <b-col>
                        ...
                        <slot v-if="$store.state.userInfo.permissions.includes(55)"> 
                             <b-button variant="success" class="ml-2" @click="updateDcInfo">আপডেট করুন</b-button>
                        </slot>
                       </b-col>
                   </b-row>
               </b-col>
          ...
          <b-modal id="new-dc-form" title="জেলা প্রশাসক তথ্য" size="xl" ok-only ok-variant="secondary" ok-title="Close">
           <b-row>
               <b-col>
                   <b-row>
                    <b-col>
                   ...
                   <b-row class="mt-2">
                       ...
                       <b-col>
                            <b-button variant="danger" @click="resetForm">মুছুন</b-button>
                        <slot v-if="$store.state.userInfo.permissions.includes(54)">
                             <b-button variant="success" class="ml-2" @click="storeDcInfo">সংরক্ষণ করুন</b-button>
                        </slot>
                       </b-col>
                   </b-row>
               </b-col>
...
export default{
    ...
    methods:{
        ...
        async updateDcInfo(){
            ...
            let url="staff/settings/district/update/dc/info";
        ...
        async storeDcInfo(){
            ...
            let url="staff/settings/district/store/dc/info";
        ...
        async getDcInfo(dataId){
            ...
            let url="staff/settings/district/get/dc/info?dataId="+dataId;
            this.dataId=dataId;
        ...
        async getDataList(){
            ...
            let url="staff/settings/district/get/dc/list?page="+this.pageNo+"&numOfData="+this.numOfData+"&searchKey="+this.searchKey;
